...
public class MLSystemManager {
	...
	public SupervisedLearner getLearner(String model, Random rand) throws Exception
	{
		...
		else if (model.equals("perceptron")) return new algorithms.perceptron.Perceptron(rand);
		else if (model.equals("qperceptron")) return new algorithms.perceptron.SpecialPerceptron(rand);
		else if (model.equals("neuralnet")) return new algorithms.mlp.NewMLP(rand);
